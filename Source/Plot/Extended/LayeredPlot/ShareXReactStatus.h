...
class	CShareXReactStatus : public CReactStatus
{
public:
	CShareXReactStatus();
	virtual	~CShareXReactStatus();
...
template<class PlotImplT>
CShareXReactStatus<PlotImplT>::CShareXReactStatus()
{
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::UnlightAll()
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::UnselectAll()
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::UnlightAll( bool bTitle, bool bAxes, bool bDatasets)
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::UnselectAll( bool bTitle, bool bAxes, bool bDatasets)
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::SwitchSelection()
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::SwitchSelAxes()
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::SwitchSelPlotData()
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
void	CShareXReactStatus<PlotImplT>::SwitchSelTitle()
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
...
template<class PlotImplT>
bool	CShareXReactStatus<PlotImplT>::ShowDlgBySelection(HDC hDC)
{
	PlotImplT* pT = static_cast<PlotImplT*>(this);
