...
class	CShareXAxesHandler
{
public:
	CShareXAxesHandler();
	virtual	~CShareXAxesHandler();
...
template<class HandlerT>
CShareXAxesHandler<HandlerT>::CShareXAxesHandler()
{
...
int		CShareXAxesHandler<HandlerT>::GetLocationFromRegion( int region )
{
	int location;
	switch(region)
	{
...
template <typename HandlerT>
bool	CShareXAxesHandler<HandlerT>::SelectAxisFromRegion( int region )
{
	HandlerT *pT=static_cast<HandlerT*>(this);
...
template <typename HandlerT>
bool	CShareXAxesHandler<HandlerT>::LightAxisFromRegion( int region )
{
	HandlerT *pT=static_cast<HandlerT*>(this);
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::LButtonDown( HDC hDC, POINT point, UINT ctrlKey )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
	...
	if( (region == kXYRegionLeft || region == kXYRegionRight) && top>=0 )
	{
	...
	else if( (region == kXYRegionTop || region == kXYRegionBottom) && top==-1 )
	{
		location = GetLocationFromRegion(region);
		axis = pT->GetPlot()->GetAxisByLocation(location);
		if(axis)
		{
			pT->GetPlot()->UnselectAll();
			pT->GetPlot()->SelectAxisFromRegion(region);
		}
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::LButtonUp( HDC hDC, POINT point, UINT ctrlKey )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::LButtonDblClk( HDC hDC, POINT point, UINT ctrlKey )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
	if(!pT->GetPlot()->IsReactAxes())return false;
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::MouseMove( HDC hDC, POINT point, UINT ctrlKey )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
	...
	else if( (region == kXYRegionTop || region == kXYRegionBottom) && top == -1)
	{
		...
		if(axis)
		{
			pT->GetPlot()->UnlightAll();
			pT->GetPlot()->SetLightDataRegion(false);
			pT->GetPlot()->LightAxisFromRegion(region);
		}
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::MouseLeave( HDC hDC, POINT point, UINT ctrlKey )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::ContextMenu( HMENU hMenu, HDC hDC, POINT point )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
...
template<class HandlerT>
bool	CShareXAxesHandler<HandlerT>::KeyDown( HDC hDC, UINT key )
{
	HandlerT* pT = static_cast<HandlerT*>(this);
