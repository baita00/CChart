...
const struct stColorTables
{
	int			nColors;
	COLORREF	*pColorTable;
	TCHAR		szColorTable[24];
}ColorTables[] =
{
	{sizeof(crTableDef)/sizeof(crTableDef[0])		,(COLORREF *)crTableDef			,_T("Default")},
	{sizeof(crTableWhite)/sizeof(crTableWhite[0])	,(COLORREF *)crTableWhite		,_T("White")},
	{sizeof(crTableGrey)/sizeof(crTableGrey[0])	,(COLORREF *)crTableGrey		,_T("Grey")},
	{sizeof(crTableBlue)/sizeof(crTableBlue[0])	,(COLORREF *)crTableBlue		,_T("Blue")},
	{sizeof(crTableCyan)/sizeof(crTableCyan[0])	,(COLORREF *)crTableCyan		,_T("Cyan")},
	{sizeof(crTableYellow)/sizeof(crTableYellow[0])	,(COLORREF *)crTableYellow		,_T("Yellow")},
	{sizeof(crTableBrown)/sizeof(crTableBrown[0])	,(COLORREF *)crTableBrown		,_T("Brown")},
	{sizeof(crTableOrange)/sizeof(crTableOrange[0])	,(COLORREF *)crTableOrange		,_T("Orange")},
	{sizeof(crTablePink)/sizeof(crTablePink[0])	,(COLORREF *)crTablePink		,_T("Pink")},
};

/*
// 编码表个数
const int COLOR_SCALE_COUNT=12;
